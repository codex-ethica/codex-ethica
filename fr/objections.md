...
Pour les fondements philosophiques et des réponses argumentées en profondeur, voir le document [Notre Approche Philosophique]({{ '/fr/philosophy/' | relative_url }}).
...
Comme détaillé dans notre [4. Dialogue avec les éthiques religieuses et convictionnelles]({{ '/fr/philosophy/' | relative_url }}#4-dialogue-avec-les-%C3%A9thiques-religieuses-et-convictionnelles), nous reconnaissons la diversité des convictions et l'apport historique et actuel des religions à la morale et à la solidarité.  
...
Les [6. Études de cas emblématiques]({{ '/fr/philosophy/' | relative_url }}#6-%C3%A9tudes-de-cas-embl%C3%A9matiques) et les [7. Applications et pratiques concrètes]({{ '/fr/philosophy/' | relative_url }}#7-applications-concr%C3%A8tes) présentées dans nos fondements philosophiques illustrent comment ces principes peuvent guider des choix concrets en matière d'éducation, d'écologie, de justice sociale, de bioéthique ou de gouvernance des technologies. De plus, la [10. Méthodologie de gestion des désaccords]({{ '/fr/philosophy/' | relative_url }}#10-m%C3%A9thodologie-de-gestion-des-d%C3%A9saccords) propose une démarche pragmatique pour aborder les dilemmes. 
...
Chacun peut proposer des modifications ou des critiques fondées, et le cadre est destiné à évoluer avec le débat collectif et l'apport de nouvelles réflexions, conformément au principe de faillibilité que nous défendons ([voir 10. Méthodologie de gestion des désaccords]({{ '/fr/philosophy/' | relative_url }}#10-m%C3%A9thodologie-de-gestion-des-d%C3%A9saccords)).
...
C'est justement le contraire d'un dogme, qui par définition est une vérité révélée ou imposée comme intangible. Ici, la démarche est celle d'une co-construction continue, en accord avec notre [10. Méthodologie de gestion des désaccords]({{ '/fr/philosophy/' | relative_url }}#10-m%C3%A9thodologie-de-gestion-des-d%C3%A9saccords).
...
La [10. Méthodologie de gestion des désaccords]({{ '/fr/philosophy/' | relative_url }}#10-m%C3%A9thodologie-de-gestion-des-d%C3%A9saccords) que nous proposons détaille comment de tels processus peuvent être menés de manière équitable et transparente.
...
- La **possibilité constante de remise en question** et de révision (le [10. Méthodologie de gestion des désaccords]({{ '/fr/philosophy/' | relative_url }}#10-m%C3%A9thodologie-de-gestion-des-d%C3%A9saccords)).
...
Les principes fondamentaux sont formulés de manière aussi claire que possible, et les [Dix principes pour une morale sans dieux]({{ '/fr/principles/' | relative_url }}), accompagnés de leurs [Fondements Philosophiques des Dix Principes]({{ '/fr/principles_foundations/' | relative_url }}), sont conçus pour être facilement compréhensibles et applicables.  
